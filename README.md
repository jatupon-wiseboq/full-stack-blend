...
1. Run "git stash".
2. Run "git fetch boilerplate 1.19".
3. Run "git merge 1.19 --allow-unrelated-histories".
4. Run "git stash apply".

To list all of hotfixes:

1. Run "git checkout 1.19".
2. Run "git pull".
...
Because we often release regular updates on stackblend.org, which right now is version 1.19. If you preferred one that you were working with, please run the editor cloned from the releases of full-stack-blend instead. Where you may find out the current version that you are using from README.md file.
