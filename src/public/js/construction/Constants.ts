...
export const ALL_DOCUMENT_SUPPORT_OF_CAMEL_OF_EVENTS = ['onfsbafterprint', 'onfsbbeforeprint', 'onfsbbeforeunload', 'onfsberror', 'onfsbhashchange', 'onfsbload', 'onfsbmessage', 'onfsboffline', 'onfsbonline', 'onfsbpagehide', 'onfsbpageshow', 'onfsbpopstate', 'onfsbresize', 'onfsbstorage', 'onfsbunload'];
