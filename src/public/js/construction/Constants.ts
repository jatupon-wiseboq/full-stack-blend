...
export const ALL_DOCUMENT_SUPPORT_OF_CAMEL_OF_EVENTS = ['onfsbafterprint', 'onfsbbeforeprint', 'onfsbbeforeunload', 'onfsberror', 'onfsbhashchange', 'onfsbload', 'onfsbmessage', 'onfsboffline', 'onfsbonline', 'onfsbpagehide', 'onfsbpageshow', 'onfsbpopstate', 'onfsbready', 'onfsbresize', 'onfsbstorage', 'onfsbunload'];
...
export const REACT_DISPLAY_LOGIC_OPTIONS = [["internal-fsb-react-display-logic", "always", ["d-none", "Always"]], ["internal-fsb-react-display-logic", "statement", ["d-none", "Statement"]], ["internal-fsb-react-display-logic", null, ["d-none", "Automatic"]]];
