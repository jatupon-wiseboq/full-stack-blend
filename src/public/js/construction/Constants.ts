...
export const BACKEND_CONNECTION_GROUPS = ['RelationalTable', 'DocumentTable', 'WorkerInstance', 'VolatileMemory', 'RESTful', 'Scheduler'];
export const BACKEND_CONNECTION_ENTITIES = ['RelationalColumn', 'DocumentNotation', 'WorkerQueue', 'VolatilePrefix', 'Verb', 'Timing'];
...
export const BACKEND_AUDIT_COLLECTING_OPTIONS = [["data-audit-collecting-option", null, ["d-none", "Include"]], ["data-audit-collecting-option", "exclude", ["d-none", "Exclude"]]];
