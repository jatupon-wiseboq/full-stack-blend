...
export const DOT_NOTATION_CONSUMABLE_TAG_LIST = [['iframe', 'src', '{', '}'], ['a', 'dangerouslySetInnerHTML', '{{__html: ', '}}'], ['svg', 'dangerouslySetInnerHTML', '{{__html: ', '}}'], ['input', 'value', '{', '}'], ['textarea', 'value', '{', '}'], ['select', 'value', '{', '}'], ['button', 'dangerouslySetInnerHTML', '{{__html: CodeHelper.escape(', ')}}'], ['img', 'src', '{', '}'], ['video', 'src', '{', '}']];
