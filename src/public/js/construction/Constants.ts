...
export const SSR_ACCUMULATE_OPTIONS = [["internal-fsb-ssr-accumulate", "reset", ["fa-eraser", "Reset"]], ["internal-fsb-ssr-accumulate", null, ["fa-dot-circle-o", "Automatic"]]];
export const SSR_DISPLAY_LOGIC_OPTIONS = [["internal-fsb-ssr-display-logic", "always", ["fa-edit", "Always"]], ["internal-fsb-ssr-display-logic", "statement", ["fa-code", "Code"]], ["internal-fsb-ssr-display-logic", null, ["fa-database", "Automatic"]]];
...
export const DOT_NOTATION_CONSUMABLE_TAG_LIST_FALLBACK = [['iframe', 'src', '', ''], ['a', '__INLINE__', '#{', '}'], ['svg', '__INLINE__', '#{', '}'], ['input', 'value', '', ''], ['textarea', 'value', '', ''], ['select', 'value', '', ''], ['img', 'src', '', ''], ['video', 'src', '', '']];
export const DOT_NOTATION_CONSUMABLE_CLASS_LIST_FALLBACK = [['HTML', '__INLINE__', '#{', '}'], ['TextElement', '__INLINE__', '#{', '}']];
...
export const ANIMATABLE_CSS_PROPERTIES_WITHOUT_OVERRIDING = ['transform'];
...
export const BACKEND_DATA_WORKER_QUEUE_GROUP_1 = [["data-worker-group", null, ["d-none", "General"]], ["data-worker-group", "serverA", ["fa-puzzle-piece", "Web"]], ["data-worker-group", "serverB", ["fa-cogs", "Web"]], ["data-worker-group", "serverC", ["fa-inbox", "Web"]]];
export const BACKEND_DATA_WORKER_QUEUE_GROUP_2 = [["data-worker-group", "workerA", ["fa-puzzle-piece", "Worker"]], ["data-worker-group", "workerB", ["fa-cogs", "Worker"]], ["data-worker-group", "workerC", ["fa-inbox", "Worker"]]];
