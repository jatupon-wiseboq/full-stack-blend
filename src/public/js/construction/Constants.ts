...
export const ALL_DOCUMENT_SUPPORT_OF_CAMEL_OF_EVENTS = ['onfsbafterprint', 'onfsbbeforeprint', 'onfsbbeforeunload', 'onfsberror', 'onfsbhashchange', 'onfsbload', 'onfsbmessage', 'onfsboffline', 'onfsbonline', 'onfsbpagehide', 'onfsbpageshow', 'onfsbpopstate', 'onfsbready', 'onfsbresize', 'onfsbstorage', 'onfsbunload', 'onfsbdocumentclick', 'onfsbdocumentdblclick', 'onfsbdocumentmousedown', 'onfsbdocumentmousemove', 'onfsbdocumentmouseout', 'onfsbdocumentmouseover', 'onfsbdocumentmouseup', 'onfsbdocumentmousewheel', 'onfsbdocumentwheel', 'onfsbdocumentkeydown', 'onfsbdocumentkeypress', 'onfsbdocumentkeyup', 'onfsbdocumenttouchstart', 'onfsbdocumenttouchmove', 'onfsbdocumenttouchend', 'onfsbdocumenttouchcancel'];
