...
export const FORWARED_ATTRIBUTES_FOR_CHILDREN = ['placeholder', 'value', 'checked', 'disabled', 'readonly', 'required', 'tabIndex', 'size', 'type', 'internal-fsb-data-source-type', 'internal-fsb-data-source-name', 'internal-fsb-data-source-column', 'multiple', 'rows', 'src', 'name'];
...
export const DATA_WIZARD_TYPE_OPTIONS_2 = [["internal-fsb-data-wizard-type", "retrieve", ["fa-database", "Retrieve"]], ["internal-fsb-data-wizard-type", "popup", ["fa-list-alt", "Popup"]], ["internal-fsb-data-wizard-type", "navigate", ["fa-link", "Navigate"]]];
...
export const DOT_NOTATION_CONSUMABLE_TAG_LIST = [['iframe', 'src', '{', '}'], ['a', 'dangerouslySetInnerHTML', '{{__html: ', '}}'], ['svg', 'dangerouslySetInnerHTML', '{{__html: ', '}}'], ['input', 'defaultValue', '{', '}'], ['textarea', 'defaultValue', '{', '}'], ['select', 'defaultValue', '{', '}'], ['button', 'dangerouslySetInnerHTML', '{{__html: ', '}}'], ['img', 'src', '{', '}'], ['video', 'src', '{', '}']];
