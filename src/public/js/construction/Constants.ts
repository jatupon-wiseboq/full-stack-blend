...
export const DATA_WIZARD_REAL_TIME_UPDATE = [["internal-fsb-data-wizard-real-time-update", null, ["fa-circle-o", "Disable"]], ["internal-fsb-data-wizard-real-time-update", "true", ["fa-circle", "Enable"]]];
