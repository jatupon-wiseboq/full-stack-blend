...
export const DOT_NOTATION_CONSUMABLE_TAG_LIST = [['iframe', 'src', '{', '}'], ['div', 'dangerouslySetInnerHTML', '{{__html: ', '}}'], ['input', 'value', '{', '}'], ['textarea', 'dangerouslySetInnerHTML', '{{__html: CodeHelper.escape(', ')}}'], ['select', 'value', '{', '}'], ['button', 'dangerouslySetInnerHTML', '{{__html: CodeHelper.escape(', ')}}'], ['img', 'src', '{', '}'], ['video', 'src', '{', '}']];
export const DOT_NOTATION_CONSUMABLE_CLASS_LIST = [['Textbox', 'dangerouslySetInnerHTML', '{{__html: CodeHelper.escape(', ')}}']];
