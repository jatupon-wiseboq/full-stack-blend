...
export const DOT_NOTATION_CONSUMABLE_CLASS_LIST = [['HTMLElement', 'dangerouslySetInnerHTML', '{{__html: ', '}}'], ['TextElement', 'dangerouslySetInnerHTML', '{{__html: CodeHelper.escape(', ')}}']];
