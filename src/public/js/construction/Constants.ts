...
export const BACKEND_CONNECTION_GROUPS = ['RelationalTable', 'DocumentTable', 'Queue', 'VolatileMemory', 'RESTful', 'Scheduler'];
export const BACKEND_CONNECTION_ENTITIES = ['RelationalColumn', 'DocumentNotation', 'Parameter', 'VolatilePrefix', 'Verb', 'Timing'];
