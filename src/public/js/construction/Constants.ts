...
export const DOT_NOTATION_CONSUMABLE_TAG_LIST = [['iframe', 'src', '{', '}'], ['a', 'dangerouslySetInnerHTML', '{{__html: ', '}}'], ['svg', 'dangerouslySetInnerHTML', '{{__html: ', '}}'], ['input', 'defaultValue', '{', '}'], ['textarea', 'defaultValue', '{', '}'], ['select', 'defaultValue', '{', '}'], ['button', 'dangerouslySetInnerHTML', '{{__html: CodeHelper.escape(', ')}}'], ['img', 'src', '{', '}'], ['video', 'src', '{', '}']];
