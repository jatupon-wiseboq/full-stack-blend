...
export const LIST_STYLE_OPTIONS = [null, "disc", "armenian", "circle", "cjk-ideographic", "decimal", "decimal-leading-zero", "georgian", "hebrew", "hiragana", "hiragana-iroha", "katakana", "katakana-iroha", "lower-alpha", "lower-greek", "lower-latin", "lower-roman", "none", "square", "upper-alpha", "upper-greek", "upper-latin", "upper-roman"];
export const LIST_STYLE_IMAGE_OPTIONS = [null, "{BROWSE}"];
export const LIST_STYLE_POSITION_OPTIONS = [null, "inside", "outside"];
export const LIST_STYLE_TYPE_OPTIONS = LIST_STYLE_OPTIONS;
...
export const FONT_SIZE_OPTIONS = [null, "{SIZE}"];
