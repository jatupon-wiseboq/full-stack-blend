...
watchingAttributeNames.push('internal-fsb-data-wizard-type');
...
watchingAttributeNames.push('value');
watchingAttributeNames.push('required');
watchingAttributeNames.push('internal-fsb-data-controls');

Object.assign(ExtendedDefaultProps, {
  watchingAttributeNames: watchingAttributeNames,
  watchingExtensionNames: ['autoGeneratedCodeForBackEndScript', 'autoGeneratedCodeForMergingBackEndScript']
});
...
class BackEndScriptEditor extends Base<Props, State> {
    ...
    public update(properties: any) {
        ...
        let code, mapping;
        if (this.state.attributeValues['internal-fsb-data-wizard-type']) {
            let info = this.state.attributeValues;
            info.autoGeneratedCodeForBackEndScript = this.state.extensionValues['autoGeneratedCodeForBackEndScript'];
