...
watchingExtensionNames.push('isFirstElementOfComponent');
...
class BackEndScriptEditor extends Base<Props, State> {
    ...
    public update(properties: any) {
        ...
        let code, mapping;
        if (['site'].indexOf(this.state.extensionValues['editing']) != -1 || (!this.state.extensionValues['isFirstElementOfComponent'] &&
